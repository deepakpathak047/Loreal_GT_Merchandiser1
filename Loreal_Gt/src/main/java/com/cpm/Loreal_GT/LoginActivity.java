		...
		protected String doInBackground(Void... params) {
			...
			try {
				...
				/*else if (result.toString().equalsIgnoreCase(
						CommonString1.KEY_FAIL)) {

					editor.putString(CommonString1.KEY_USERNAME, "testmer");
					editor.putString(CommonString1.KEY_PASSWORD, password);
					editor.putString(CommonString1.KEY_VERSION, "1");

					editor.putString(CommonString1.KEY_PATH, "http://li.parinaam.in/dl/lorea10.apk");

					editor.putString(CommonString1.KEY_DATE,"09/01/2016");

					editor.putString(CommonString1.KEY_USER_TYPE, "Merchandiser");
