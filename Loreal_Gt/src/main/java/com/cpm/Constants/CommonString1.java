...
public class CommonString1 {
	...
	public static final String FILE_PATH = Environment.getExternalStorageDirectory() + "/LorealGT_Images/";
...
public static final String TABLE_INSERT_HEADER_FOOD_STORE_DATA = "openingHeader_FOOD_STORE_data";
	...
	public static final String CREATE_TABLE_STOCK_PRESENT = "CREATE TABLE IF NOT EXISTS STOCK_DATA_PRESENT " +
			"(Common_Id INTEGER, SKU_CD VARCHAR,SKU VARCHAR,BRAND_CD VARCHAR," +
			" BRAND VARCHAR,STORE_CD VARCHAR,STATE_CD VARCHAR,STORE_TYPE_CD VARCHAR,OPENING_STOCK_PRESENT INTEGER)";
	...
	public static final String KEY_SUB_REASON = "SUB_REASON";
	...
	public static final String CREATE_TABLE_SHARESHELF_HEADER_DATA = "CREATE TABLE "
	...
	public static final String CREATE_TABLE_SHARESHELF_CHILD_DATA = "CREATE TABLE "
